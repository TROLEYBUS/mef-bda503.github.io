...
file_list <- c(
  ...
  m1803 = "https://github.com/MEF-BDA503/pj18-Baris-Can-Tayiz/blob/master/odd_car_sales_data_march_18new.rds?raw=true",
  #Lastly, I have changed NA values to zeros.
